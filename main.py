        ...
        if self.xpath_exists(wrong_userpage):
            ...
            try:
                ...
                for i in range(1, loops_count + 1):
                    browser.execute_script("arguments[0].scrolHeight", followers_ul)
                    time.sleep(random.randint(2, 5))
                    print(f'Iteration # {i}')

                all_urls = followers_ul.find_elements(By.TAG_NAME, 'li')
                    ...
                    try:
                        ...
                        if self.xpath_exists("//a[@class='x1i10hfl xjbqb8w x6umtig x1b1mbwd xaqea5y xav7gou x9f619 x1ypdohk xt0psk2 xe8uvvx xdj266r x11i5rnm xat24cr x1mh8g0r xexx8yu x4uap5 x18d9i69 xkhd6sd x16tdsg8 x1hl2dhg xggy1nq x1a2a7pz _acan _acap _acat _acaw _a6hd']"):
                            ...
                            if self.xpath_exists():
                                try:
                                    follow_button = browser.find(By.XPATH).click()
                                    print()
                                except Exception as ex:
                                    print(ex)
                            else:
...
my_bot.login()
my_bot.download_userpage_content('https://www.instagram.com/________/')
